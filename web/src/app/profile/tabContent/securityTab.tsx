    ...
    <>
      <div className="flex py-8 border-b">
        ...
        <div className="flex items-center gap-3">
          <div className="flex items-center justify-center bg-background rounded-full min-h-[65px] min-w-[65px] max-h-[65px] max-w-[65px] aspect-square text-2xl font-normal border-2 border-gray-900 text-default py-2">
            {user && user.email ? (
