    ...
    <AuthFlowContainer>
      <div className="flex flex-col space-y-6">
        ...
        <p className="text-text-700 max-w-md text-center">
          We couldn&apos;t find your account in our records. To access Junie AI,
          you need to either:
        </p>
        <ul className="list-disc text-left text-text-600 w-full pl-6 mx-auto">
          <li>Be invited to an existing Junie AI organization</li>
          <li>Create a new Junie AI organization</li>
        </ul>
