...
import { Persona, StarterMessage } from "../admin/assistants/interfaces";
      ...
      <div className="flex justify-center w-full py-20">
        <div className="max-w-full 2xl:w-searchbar px-5 2xl:px-0 pt-10 md:pt-16 lg:pt-0 2xl:pt-14">
          ...
          {/* <div className="grid grid-cols-2 md:grid-cols-4 gap-4 pt-10">
            {currentPersona.starter_messages.map((message, i) => (
              <Card
                key={i}
                className="h-[180px] p-4 justify-between md:flex flex-col cursor-pointer border-input-colored hidden"
              >
