  ...
  return (
    <>
      <div className="flex justify-center w-full">
        <div className="2xl:w-searchbar-sm 3xl:w-searchbar">
          <div className="flex pt-16">
            <div className="mx-auto">
              <Logo height={80} width={80} className="m-auto" />

              <h1 className="flex flex-col items-center text-[44px] font-semibold h1-bg leading-[1.3] text-center">
                <span>Assistant with no access to documents.</span>
                <span>Chat with just the Language Model.</span>
              </h1>
              {/* <div className="m-auto mt-4 text-3xl font-bold text-strong w-fit">
                {selectedPersona?.name || "How can I help you today?"}
              </div>
          ...
          <div className="grid grid-cols-4 gap-4 pt-10">
            <Card className="h-[180px] p-4 justify-between flex flex-col border-input-colored">
