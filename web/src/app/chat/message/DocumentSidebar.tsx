...
const DocumentCard: React.FC<DocumentCardProps> = ({
  ...
  return (
    <div
      key={doc.document_id}
      className={`w-[200px] rounded-lg flex-none transition-all duration-500 opacity-90 hover:bg-background-200 bg-text-100 px-4 py-2 border-b cursor-pointer
        ${
          !isComplete
            ? "animate-pulse"
            : citedDocuments &&
    ...
    >
      <div className="text-sm flex justify-between font-semibold text-text-800">
