    ...
    <>
      ...
      <div className="flex relative bg-background text-default ">
        ...
        <div
          ...
          className="flex relative  w-full overflow-x-hidden"
        >
          {popup}
          {currentFeedback && (
            <FeedbackModal
          ...
          <div className="flex h-svh bg-black flex-col w-full">
            {/* {liveAssistant && (
              <FunctionalHeader
                page="chat"
              ...
              <Dropzone onDrop={handleImageUpload} noClick>
                {({ getRootProps }) => (
                  <div className="flex h-full w-full">
                    ...
                    ></div> */}
                    <div
                      className={`h-full w-full relative transition-margin duration-300 overflow-x-auto desktop:pb-[140px]`}
                      // {...getRootProps()}
                    >
                      {/* <input {...getInputProps()} /> */}
