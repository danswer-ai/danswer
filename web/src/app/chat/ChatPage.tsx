...
import { PepsiIcon } from "@/components/icons/icons";
                      ...
                      the top of the chat page. Oly used in the EE version of the app. */}
                        ...
                        >
                          <div className="w-[95%] mx-auto relative mb-8">
                            ...
                            {/* <div className="mt-4 flex items-center justify-center relative w-[95%] mx-auto">
                              <div className="text-sm text-text-500 max-w-searchbar-max px-4 text-center">
                                TritonGPT responses are generated by artificial intelligence and may contain errors. Check sources and refer to actual policies and laws for reliable information. | Terms of Use
                              </div>
                            ...
                            <div className="absolute right-0 bottom-0">
                              <img
                                className="h-8 w-fit"
                                src="https://res.cloudinary.com/vistaprint/images/c_scale,w_448,h_135,dpr_2/f_auto,q_auto/v1706001816/ideas-and-advice-prod/en-us/Pepsi_logo_emblem_logotype-2/Pepsi_logo_emblem_logotype-2.png?_i=AA"
                              />
                            </div>
                          </div>
                        </div>
