    ...
    <div className="fixed top-0 -translate-x-1/2 w-full left-1/2 bg-[rgba(255,_255,_255,_0.5)] z-[9999] flex items-center justify-center backdrop-blur-md">
      <Wrapper>
        <div className="flex items-center justify-between w-full py-4">
          ...
          <div
            className="flex flex-col justify-center h-10 gap-1.5 md:gap-2 lg:gap-3 xl:hidden z-[9999]"
            onClick={toggleMenu}
          >
            <div
              className={`w-6 md:w-12 lg:w-[75px] h-0.5 bg-black dark:bg-white transition-all duration-300 ease-in-out relative ${
                openMenu
                  ? "rotate-[45deg] md:rotate-[38deg] lg:rotate-[40deg] top-1 md:top-1.5"
                  : "rotate-0 top-0"
              }`}
            />
            <div
              className={`w-6 md:w-12 lg:w-[75px] h-0.5 bg-black dark:bg-white transition-all duration-300 ease-in-out relative ${
                openMenu
                  ? "rotate-[-45deg] md:rotate-[-38deg] lg:rotate-[-40deg] -top-1 lg:-top-2"
                  : "rotate-0 top-0"
              }`}
            />
          </div>
