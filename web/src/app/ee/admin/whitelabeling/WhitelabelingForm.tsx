            ...
            {showAdvancedOptions && (
              <div className="w-full flex flex-col gap-y-4">
                <Text>
                  Read{" "}
                  <Link
                    href={"https://docs.onyx.dev/enterprise_edition/theming"}
                ...
                <TextFormField
                  ...
                  subtext={
                    values.enable_consent_screen
                      ...
                      : `The title for the popup that will be displayed for each user on their initial visit to the application. If left blank AND Custom Popup Content is specified, will use "Welcome to ${values.application_name || "onyx"}!".`
                  }
                  placeholder={
                    values.enable_consent_screen
                      ? "Consent Screen Header"
