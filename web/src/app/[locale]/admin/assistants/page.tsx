...
export default async function Page() {
  return (
    <div className="mx-auto container">
      ...
      <Text className="mb-2">Assistants are a way to build custom search/question-answering experiences for different use cases.</Text>
      ...
      <div>
        ...
        >
          <div className="mx-auto flex">
            <FiPlusSquare className="my-auto mr-2" />New Assistant</div>
        </Link>
