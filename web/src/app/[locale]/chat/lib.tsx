...
export function useScrollonStream({
  ...
  // This useEffect handles synchronous scroll behavior and UI adjustments
  useEffect(() => {
  ...
  }, [chatState, distance, scrollDist, scrollableDivRef, debounceNumber, endDivRef]);

  // This useEffect scrolls to the end if chatState changes
  useEffect(() => {
