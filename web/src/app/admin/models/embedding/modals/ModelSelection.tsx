...
export function ModelSelectionConfirmationCloud({
  selectedModel,
  isCustom,
  onConfirm,
}: {
  selectedModel: CloudEmbeddingModel;
  isCustom: boolean;
  onConfirm: () => void;
}) {
  return (
...
export function ModelSelectionConfirmationModalCloud({
  selectedModel,
  isCustom,
  onConfirm,
  onCancel,
  ...
  return (
    <Modal title="Update Embedding Model" onOutsideClick={onCancel}>
      <div>
        <ModelSelectionConfirmationCloud
          selectedModel={selectedModel}
          isCustom={isCustom}
          onConfirm={onConfirm}
        />
  ...
  return (
    <div className="mb-4">
      <Text className="text-lg mb-2">
        ...
        and gather your &quot;API KEY&quot;.
      </Text>

      <p>
        Please note that using this will cost around $4000! Learn more about
        costs at <a>this page</a>.
      </p>
