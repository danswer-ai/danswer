...
// export interface FullCloudEmbeddingProvider extends AIProvider {
//   api_key?: string;
//   api_base?: string;
//   api_version?: string;
//   custom_config?: Record<string, string>;
//   default_model_name: string;
//   models: FullCloudbasedEmbeddingModelDescriptor[];
//   is_configured: boolean;
//   is_default_provider?: boolean;
// }
...
// export interface FullCloudbasedEmbeddingModelDescriptor {
//   name: string;
//   description: string;
//   is_configured: boolean;
//   model_dim: number;
...
// // export interface FullCloudEmbeddingProvider {
// //   id: string;
// //   name: string;
// //   website: string;
// //   icon: ({ size, className }: IconProps) => JSX.Element;
...
// export const AVAILABLE_CLOUD_MODELS: FullCloudEmbeddingProvider[] = [
//   {
//     id: "openai",
//     name: "OpenAI",
//     website: "https://openai.com",
