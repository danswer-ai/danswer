  ...
  return (
    <div>
        ...
        <Modal>
          <div>
            <div>
              ...
              <br />
              <br />
              Connectors are the way that Uni Wise gets data from your
              organization&apos;s various data sources. Once setup, we&apos;ll
              automatically sync data from your apps and docs into Uni Wise, so
      ...
      <Text>
        ...
        which then power Uni Wise&apos;s search.
      </Text>
        ...
        (!newModelSelection ? (
          <div>
            ...
            <Text className="mt-6">
              ...
              .
              <br />
              <b>NOTE:</b> not all models listed will work with Uni Wise, since
