...
const Main = () => {
  ...
  return (
    <div className="mb-8">
      ...
      <Text className="mb-2">
        Setup a Slack bot that connects to Uni Wise. Once setup, you will be able
        to ask questions to Uni Wise directly from Slack. Additionally, you can:
      </Text>

      <Text className="mb-2">
        <ul className="list-disc mt-2 ml-4">
          <li>
            Setup Uni WiseBot to automatically answer questions in certain
            channels.
          </li>
          <li>
            Choose which document sets Uni WiseBot should answer from, depending
            on the channel the question is being asked.
          </li>
          <li>
            Directly message Uni WiseBot to search just as you would in the web
            UI.
          </li>
        </ul>
      </Text>
      ...
      <Text className="mb-6">
        ...
        found in the Uni Wise documentation to get started!
      </Text>
      ...
      {slackBotTokens && (
        <>
          <Title className="mb-2 mt-4">Step 2: Setup Uni WiseBot</Title>
          <Text className="mb-3">
            Configure Uni Wise to automatically answer questions in Slack
            channels. By default, Uni Wise only responds in channels where a
