    ...
    <div className="mb-8">
      ...
      <Text className="mb-6">
        ...
        <a
          ...
          href="https://docs.docudive.dev/slack_bot_setup"
          target="_blank"
        >
          guide{" "}
        </a>
      ...
      {slackBotTokens && (
        <>
          <Title className="mb-2 mt-4">Step 2: Setup DocuDiveBot</Title>
          <Text className="mb-3">
            Configure DocuDive to automatically answer questions in Slack
            channels. By default, DocuDive only responds in channels where a
