...
const Main = () => {
  ...
  return (
    <div className="mb-8">
      ...
      <Text className="mb-2">
        Setup a Slack bot that connects to onyx. Once setup, you will be able to
      ...
      <Text className="mb-6">
        ...
        <a
          ...
          href="https://docs.onyx.dev/slack_bot_setup"
          target="_blank"
        >
          guide{" "}
        </a>
      ...
      {slackBotTokens && (
        <>
          <Title className="mb-2 mt-4">Step 2: Setup onyxBot</Title>
          <Text className="mb-3">
            Configure onyx to automatically answer questions in Slack channels.
            By default, onyx only responds in channels where a configuration is
            setup unless it is explicitly tagged.
          </Text>
