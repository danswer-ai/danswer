      ...
      {isEnterpriseEnabled && (
        <>
          ...
          <IntegerInput
            ...
            sublabel="Enter the maximum number of days you would like Sepctra to retain chat messages. Leaving this field empty will cause Spectra to never delete chat messages."
