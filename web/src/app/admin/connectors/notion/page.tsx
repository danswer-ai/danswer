      ...
      {notionCredential ? (
        ...
        <>
          <Text>
            ...
            Notion for Spectra. Follow the instructions in the&nbsp;
            <a
            ...
            Notion docs to allow Spectra to read Notion Databases and Pages
            ...
            <CredentialForm<NotionCredentialJson>
              ...
              validationSchema={Yup.object().shape({
                notion_integration_token: Yup.string().required(
                  "Please enter the Notion Integration token for the Spectra integration."
                ),
              })}
              initialValues={{
