      ...
      {notionCredential ? (
        ...
        <>
          <Text>
            ...
            Notion for ChatOpenSource. Follow the instructions in the&nbsp;
            <a
            ...
            Notion docs to allow ChatOpenSource to read Notion Databases and Pages
            ...
            <CredentialForm<NotionCredentialJson>
              ...
              validationSchema={Yup.object().shape({
                notion_integration_token: Yup.string().required(
                  "Please enter the Notion Integration token for the ChatOpenSource integration."
                ),
              })}
              initialValues={{
