...
import {XenforoIcon, ArrowSquareOutIcon, GearIcon} from "@/components/icons/icons";
...
const Main = () => {
    ...
    const xenforoConnectorIndexingStatuses: ConnectorIndexingStatus<XenforoConfig, {}>[] =
    ...
    return (
        <>
            <Title className="mb-2 mt-6 ml-auto mr-auto">
                Step 1: Specify which XenForo v2.2 forum URL to index. Can be board or thread.
            </Title>
