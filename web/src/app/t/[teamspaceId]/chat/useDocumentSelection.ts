...
export function useDocumentSelection(): [
  EnmeddDocument[],
  (document: EnmeddDocument) => void,
  () => void,
  number,
] {
  const [selectedDocuments, setSelectedDocuments] = useState<EnmeddDocument[]>(
    []
  );
  ...
  function toggleDocumentSelection(document: EnmeddDocument) {
