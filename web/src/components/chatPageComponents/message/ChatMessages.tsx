...
import { FeedbackType } from "@/components/chatPageComponents/types";
import { useEffect, useRef, useState } from "react";
import ReactMarkdown from "react-markdown";
import { DanswerDocument } from "@/lib/search/interfaces";
import { SearchSummary, ShowHideDocsButton } from "./ChatMessageSearchSummary";
import { SourceIcon } from "@/components/SourceIcon";
import { ThreeDots } from "react-loader-spinner";
import { SkippedSearch } from "./ChatMessageSkippedSearch";
import remarkGfm from "remark-gfm";
import { CopyButton } from "@/components/CopyButton";
import { ChatFileType, FileDescriptor } from "@/components/chatPageComponents/interfaces";
import { IMAGE_GENERATION_TOOL_NAME } from "@/components/chatPageComponents/tools/constants";
import { ToolRunningAnimation } from "@/components/chatPageComponents/tools/ChatRToolsRunningAnimation";
import { Hoverable } from "@/components/Hoverable";
import { DocumentPreview } from "@/components/chatPageComponents/files/ChatFilesDocumentsPreview";
import { InMessageImage } from "@/components/chatPageComponents/files/ChatFilesInMessageImage";
