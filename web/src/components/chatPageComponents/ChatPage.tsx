...
import { DocumentSidebar } from "@/components/chatPageComponents/sidebar/ChatSidebarDocument";
...
import { ConfigurationModal } from "./modal/ChatModalConfigurationComponent";
