  ...
  return (
    <div className="h-screen overflow-y-hidden">
      ...
      <div className="flex h-full pt-16">
        <div className="h-full pt-12 pb-8 overflow-auto border-r w-80 bg-background-weak border-border">
          <AdminSidebar
            collections={[
              {
                name: "Connectors",
        ...
        <div className="w-full h-full px-12 pt-8 pb-8 overflow-y-auto">
          {children}
        </div>
      </div>
    </div>
