    ...
    <div className="text-text-settings-sidebar pl-0">
      <nav className="space-y-2">
        ...
        <div className="flex w-full justify-center">
          <Link href="/chat">
            <button className="text-sm flex items-center block w-52 py-2.5 flex px-2 text-left text-red-800 hover:bg-opacity-80 cursor-pointer rounded">
              <IoMdExit className="my-auto" size={18} />
