  ...
  if (link != "") {
    return (
      ...
      >
        <a
          ...
          className="cursor-pointer inline ml-1 align-middle inline-block text-sm text-blue-500 cursor-help leading-none inline ml-1 align-middle"
        >
          [{innerText}]
        </a>
      </CustomTooltip>
    ...
    return (
      <CustomTooltip content={<div>This doc doesn&apos;t have a link!</div>}>
        <div className="inline-block text-sm text-blue-500 cursor-help leading-none inline ml-1 align-middle">
          [{innerText}]
        </div>
      </CustomTooltip>
    );
