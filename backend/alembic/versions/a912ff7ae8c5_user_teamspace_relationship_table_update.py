...
def upgrade() -> None:
    ...
    op.add_column(
        "teamspace", sa.Column("is_custom_logo", sa.Boolean(), nullable=False)
    )
    op.add_column("user", sa.Column("is_custom_profile", sa.Boolean(), nullable=False))
...
def downgrade() -> None:
    ...
    op.drop_column("teamspace", "is_custom_logo")
    op.drop_column("user", "is_custom_profile")
    # ### end Alembic commands ###
