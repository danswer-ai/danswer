...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Docudive checkpoint saving and loading."
    )
    parser.add_argument(
        "--save", action="store_true", help="Save Docudive state to directory."
    )
    parser.add_argument(
        "--load", action="store_true", help="Load Docudive state from save directory."
    )
    parser.add_argument(
