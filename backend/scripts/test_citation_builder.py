    ...
    for i in range(num_docs):
        mock_docs.append(
            LlmDoc(
                ...
                source_links={0: f"https://example.com/doc_{i}"}
                if i % 2 == 0
                else None,
            )
        )
...
def test_extract_citations_from_stream_case1(mock_data):
    ...
    mock_tokens = create_mock_tokens(
        'I\'m sorry, but the documents provided do not contain any information about "mintlify + tasks". '
        + 'The term "mintlify" appears in a document about redirects and broken links, '
        + "but it does not mention anything about tasks [1]. "
        + 'The term "tasks" appears in a couple of documents that list various tasks for the day, but these '
        + 'do not mention "mintlify" [2][3]. '
        + "Therefore, I cannot provide a definitive answer to your query based on the provided documents."
    )
    ...
    for piece in result[1:]:
        if isinstance(piece, DanswerAnswerPiece) and isinstance(
            new_result[-1], DanswerAnswerPiece
        ):
    ...
    expected_output = [
        DanswerAnswerPiece(
            answer_piece='I\'m sorry, but the documents provided do not contain any information about "mintlify + tasks". '
            + 'The term "mintlify" appears in a document about redirects and broken links, '
            + "but it does not mention anything about tasks "
        ),
        CitationInfo(citation_num=1, document_id="doc_0"),
        DanswerAnswerPiece(
            answer_piece="[[1]](https://mintlify.com/docs/settings/broken-links). "
            + 'The term "tasks" appears in a couple of documents '
            + 'that list various tasks for the day, but these do not mention "mintlify" '
        ),
        CitationInfo(citation_num=2, document_id="doc_1"),
        DanswerAnswerPiece(
            answer_piece="[2][3]. Therefore, I cannot provide a definitive answer to your query based on the provided documents."
        ),
    ]
...
#     mock_docs, mock_doc_id_to_rank_map = mock_data
#     mock_tokens = create_mock_tokens("\"The purpose of this cycle of life, death, and rebirth is
# for the protagonist to grow, mature, and become a larger and greater intellect [1][2][3][5].\"")
...
#     expected_output = [
#         DanswerAnswerPiece(answer_piece="\"The purpose of this cycle of life, death,
# and rebirth is for the protagonist to grow, mature, and become a larger and greater intellect "),
#         CitationInfo(citation_num=3, document_id="doc_2"),
#         CitationInfo(citation_num=3, document_id="doc_2"),
#         CitationInfo(citation_num=3, document_id="doc_2"),
#         CitationInfo(citation_num=3, document_id="doc_2"),
#         DanswerAnswerPiece(answer_piece="[[3]](https://eyeofmidas.com/scifi/Weir_Egg.pdf)[
# [3]](https://eyeofmidas.com/scifi/Weir_Egg.pdf)[[3]](https://eyeofmidas.com/scifi/Weir_Egg.pdf)[[3]](https://eyeofmidas.com/scifi/Weir_Egg.pdf).\""),
#     ]
...
#     mock_docs, mock_doc_id_to_rank_map = mock_data
#     mock_tokens = create_mock_tokens("\"Tasks, as outlined in the documents, are
# activities or pieces of work to be done or undertaken. They are often listed in a to-do
#  format and can include a wide range of activities, from catching up with people,
# updating software, to scheduling the week [1][2]. On the other hand, the \"egg\"
# is a metaphor used in a short story by Andy Weir. In this context, the universe
# is described as an \"egg\" created for the maturation of the protagonist's soul.
#  Each life the protagonist lives is an opportunity for growth and maturation,
# and the protagonist is reincarnated many times to gain more experiences and
# knowledge [4][5][6].\"")
...
#     expected_output = [
#         DanswerAnswerPiece(answer_piece="\"Tasks, as outlined in the documents, are
#  activities or pieces of work to be done or undertaken. They are often listed in a to-do format
#  and can include a wide range of activities, from catching up with people, updating software, to scheduling the week "),
#         CitationInfo(citation_num=2, document_id="doc_1"),
#         CitationInfo(citation_num=2, document_id="doc_1"),
#         DanswerAnswerPiece(answer_piece="[2][2]. On the other hand, the \"egg\" is
#  a metaphor used in a short story by Andy Weir. In this context, the universe is described a
# s an \"egg\" created for the maturation of the protagonist's soul. Each life the protagonist
# lives is an opportunity for growth and maturation, and the protagonist
# is reincarnated many times to gain more experiences and knowledge "),
#         CitationInfo(citation_num=3, document_id="doc_2"),
#         CitationInfo(citation_num=3, document_id="doc_2"),
#         CitationInfo(citation_num=3, document_id="doc_2"),
#         DanswerAnswerPiece(answer_piece="[[3]](https://eyeofmidas.com/scifi/Weir_Egg.pdf)
# [[3]](https://eyeofmidas.com/scifi/Weir_Egg.pdf)[[3]](https://eyeofmidas.com/scifi/Weir_Egg.pdf).\""),
#     ]
