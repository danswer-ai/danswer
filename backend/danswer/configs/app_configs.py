...
AZURE_DALLE_API_BASE = os.environ.get("AZURE_DALLE_API_BASE", None)
AZURE_DALLE_API_VERSION = os.environ.get("AZURE_DALLE_API_VERSION", None)
AZURE_DALLE_API_KEY = os.environ.get("AZURE_DALLE_API_KEY", None)
