...
_NUM_DOCUMENT_TOKENS_FED_TO_GENERATIVE_MODEL = os.environ.get(
    "NUM_DOCUMENT_TOKENS_FED_TO_GENERATIVE_MODEL"
)
NUM_DOCUMENT_TOKENS_FED_TO_GENERATIVE_MODEL = (
    int(_NUM_DOCUMENT_TOKENS_FED_TO_GENERATIVE_MODEL)
    if _NUM_DOCUMENT_TOKENS_FED_TO_GENERATIVE_MODEL
    else 2048
)
