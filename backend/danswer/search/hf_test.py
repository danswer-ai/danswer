...
from huggingface_hub import __version__  # noqa: F401 # for backward compatibility
...
from huggingface_hub.constants import HF_HUB_ETAG_TIMEOUT
from huggingface_hub.constants import HF_TRANSFER_CONCURRENCY
...
from huggingface_hub.constants import HUGGINGFACE_HEADER_X_LINKED_SIZE
from huggingface_hub.constants import HUGGINGFACE_HEADER_X_REPO_COMMIT
...
from huggingface_hub.utils import FileMetadataError
...
@_deprecate_method(
    version="0.22.0", message="Use `huggingface_hub.utils.build_hf_headers` instead."
)
def http_user_agent(
    *,
...
def hf_hub_download(
    ...
    *,
    ...
    if etag is None:
        ...
        elif isinstance(head_call_error, RepositoryNotFoundError) or isinstance(
            head_call_error, GatedRepoError
        ):
    ...
    with FileLock(lock_path):
        ...
        if local_dir is None:
            ...
            is_big_file = (
                ...
                > constants.HF_HUB_LOCAL_DIR_AUTO_SYMLINK_THRESHOLD
            )
...
def get_hf_file_metadata(
    ...
    return HfFileMetadata(
        ...
        etag=_normalize_etag(
            r.headers.get(HUGGINGFACE_HEADER_X_LINKED_ETAG) or r.headers.get("ETag")
        ),
