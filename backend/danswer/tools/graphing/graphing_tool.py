...
system_message = """
You are an AI assistant specialized in creating Python code for generating graphs using matplotlib.
...
1. Import necessary libraries (matplotlib, numpy if needed)
...
class GraphingTool(Tool):
            ...
            "function": {
                ...
                "parameters": {
                    ...
                    "properties": {
                        "code": {
                            "type": "string",
                            "description": "Python code to generate the graph using matplotlib",
                        },
                    },
                    "required": ["code"],
                },
    ...
    def get_args_for_non_tool_calling_llm(
        ...
        return {
            "code": rephrased_query,  # This should be code generated by the LLM
        }
