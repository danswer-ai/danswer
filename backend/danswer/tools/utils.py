...
from danswer.natural_language_processing.utils import Tokenizer
...
def compute_tool_tokens(tool: Tool, llm_tokenizer: Tokenizer | None = None) -> int:
...
def compute_all_tool_tokens(
    tools: list[Tool], llm_tokenizer: Tokenizer | None = None
) -> int:
