...
from ee.enmedd.db.saml import expire_saml_account
from ee.enmedd.db.saml import get_saml_account
from ee.enmedd.db.saml import upsert_saml_account
from ee.enmedd.utils.secrets import encrypt_string
...
async def saml_login_callback(
    ...
    # Redirect to main Anrold AI search page
