...
from enmedd.db.search_settings import create_search_settings
from enmedd.db.search_settings import delete_search_settings
from enmedd.db.search_settings import get_current_search_settings
from enmedd.db.search_settings import get_embedding_provider_from_provider_type
...
def set_new_search_settings(
    ...
    if search_settings_new.index_name is None:
        ...
        index_name = f"enmedd_chunk_{clean_model_name(search_settings_new.model_name)}"
        if (
