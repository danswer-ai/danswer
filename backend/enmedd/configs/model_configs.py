...
# Additionally enMedD AI supports GPT4All and custom request library based models
...
# If using Azure, it's the engine name, for example: enMedD AI
...
# API Base, such as (for Azure): https://enmedd.openai.azure.com/
