...
from enmedd.prompts.constants import TRIPLE_BACKTICK
...
def extract_citations_from_stream(
    ...
    6. Output Generation:
    - Yields AnswerPiece objects for regular text.
    ...
    for raw_token in tokens:
        ...
        if citations_found and not in_code_block(llm_out):
            ...
            if last_citation_end > 0:
                yield AnswerPiece(answer_piece=curr_segment[:last_citation_end])
