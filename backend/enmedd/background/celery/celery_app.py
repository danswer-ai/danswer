...
from enmedd.background.celery.celery_utils import celery_is_worker_primary
from enmedd.configs.constants import CELERY_PRIMARY_WORKER_LOCK_TIMEOUT
...
from enmedd.configs.constants import POSTGRES_CELERY_WORKER_HEAVY_APP_NAME
from enmedd.configs.constants import POSTGRES_CELERY_WORKER_LIGHT_APP_NAME
from enmedd.configs.constants import POSTGRES_CELERY_WORKER_PRIMARY_APP_NAME
...
def on_worker_init(sender: Any, **kwargs: Any) -> None:
    ...
    if not celery_is_worker_primary(sender):
        ...
        time_start = time.monotonic()
        while True:
            if r.exists(EnmeddRedisLocks.PRIMARY_WORKER):
                break
    ...
    r.delete(EnmeddRedisLocks.PRIMARY_WORKER)
    ...
    # implemented yet.
    lock = r.lock(
        EnmeddRedisLocks.PRIMARY_WORKER,
