...
from enmedd.configs.app_configs import CONFLUENCE_CONNECTOR_INDEX_ONLY_ACTIVE_PAGES
from enmedd.configs.app_configs import CONFLUENCE_CONNECTOR_LABELS_TO_SKIP
from enmedd.configs.app_configs import CONFLUENCE_CONNECTOR_SKIP_LABEL_INDEXING
...
from enmedd.file_processing.html_utils import format_document_soup
...
def _extract_confluence_keys_from_cloud_url(wiki_url: str) -> tuple[str, str]:
    """Sample
    https://enmedd_ai.atlassian.net/wiki/spaces/1234abcd/overview
    wiki_base is https://enmedd_ai.atlassian.net/wiki
    space is 1234abcd
    """
...
def _extract_confluence_keys_from_datacenter_url(wiki_url: str) -> tuple[str, str]:
    """Sample
    https://enmedd_ai.ai/confluence/display/1234abcd/overview
    wiki_base is https://enmedd_ai.ai/confluence
    space is 1234abcd
    """
