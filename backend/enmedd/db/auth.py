...
from enmedd.db.engine import get_sqlalchemy_async_engine
from enmedd.db.models import AccessToken
from enmedd.db.models import OAuthAccount
...
def get_default_admin_user_emails() -> list[str]:
    ...
    get_default_admin_user_emails_fn: Callable[
        ...
        "enmedd.auth.users", "get_default_admin_user_emails_", lambda: []
    )
