...
from enmedd.db.feedback import delete_document_feedback_for_documents__no_commit
...
from enmedd.db.tag import delete_document_tags_for_documents__no_commit
from enmedd.db.utils import model_to_dict
...
def get_access_info_for_documents(
    ...
    - List of emails of enmedd users with direct access to the doc (includes a "None" element if
