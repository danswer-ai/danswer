...
def test_passed_in_quotes() -> None:
    ...
    test_answer = """{
        ...
        "quotes": [
            "enmedd can just ingest PDFs as they are. How GOOD it embeds them depends on the formatting of your PDFs.",
            "the ` enmedd. llm ` package aims to provide a comprehensive framework."
        ]
    }"""
    ...
    test_answer = """{
        ...
        "quotes": [
            "enmedd can efficiently ingest PDFs, with the quality of embedding depending on the PDF's formatting."
        ]
    }"""
    answer, quotes = separate_answer_quotes(test_answer, is_json_prompt=True)
